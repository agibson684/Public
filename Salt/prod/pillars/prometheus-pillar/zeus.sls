...
prometheus:
  wanted:
    ...
    component:
      - prometheus
{# do not turn this own, i am using my own alertmanager 
      - alertmanager #}
      - node_exporter
      - haproxy_exporter
        ...
        config:
          ...
          # A scrape configuration containing exactly one endpoint to scrape:
            ...
            - job_name: 'ssh'
              ...
              static_configs: 
                - targets:
                  - 'home.thrace-lan.info:22'
                  - 'zeus.thrace-lan.info:22'
                  - 'athena.thrace-lan.info:22'
                  labels:
                    module: default 
              relabel_configs:
